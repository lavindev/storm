...
public class HBaseSerializer {
    ...
    public Metric deserialize(byte[] data) {
        ...
        if (data != null) {
            ...
            // grab values from buffer
            byte aggLevel = bb.get();
            Integer topoId = bb.getInt();
            long timestamp = bb.getLong();
            Integer metricId = bb.getInt();
            Integer compId = bb.getInt();
            Integer execId = bb.getInt();
            Integer hostId = bb.getInt();
            ...
            Metric metric = new Metric(meta.getMetric(metricId),
                    timestamp,
                    meta.getExec(execId),
                    meta.getComp(compId),
                    getTopo(topoId),
