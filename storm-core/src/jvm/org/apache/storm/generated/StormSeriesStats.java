...
public class StormSeriesStats implements org.apache.thrift.TBase<StormSeriesStats, StormSeriesStats._Fields>, java.io.Serializable, Cloneable, Comparable<StormSeriesStats> {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.times = new ArrayList<Long>(_list856.size);
                long _elem857;
                for (int _i858 = 0; _i858 < _list856.size; ++_i858)
                {
                  _elem857 = iprot.readI64();
                  struct.times.add(_elem857);
                }
                iprot.readListEnd();
              }
          ...
          case 2: // VALUES
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map859 = iprot.readMapBegin();
                struct.values = new HashMap<String,Map<Long,Double>>(2*_map859.size);
                String _key860;
                Map<Long,Double> _val861;
                for (int _i862 = 0; _i862 < _map859.size; ++_i862)
                {
                  _key860 = iprot.readString();
                  {
                    org.apache.thrift.protocol.TMap _map863 = iprot.readMapBegin();
                    _val861 = new HashMap<Long,Double>(2*_map863.size);
                    long _key864;
                    double _val865;
                    for (int _i866 = 0; _i866 < _map863.size; ++_i866)
                    {
                      _key864 = iprot.readI64();
                      _val865 = iprot.readDouble();
                      _val861.put(_key864, _val865);
                    }
                    iprot.readMapEnd();
                  }
                  struct.values.put(_key860, _val861);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.times != null) {
        if (struct.is_set_times()) {
          oprot.writeFieldBegin(TIMES_FIELD_DESC);
          {
            ...
            for (long _iter867 : struct.times)
            {
      ...
      if (struct.values != null) {
        if (struct.is_set_values()) {
          oprot.writeFieldBegin(VALUES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Map<Long,Double>> _iter868 : struct.values.entrySet())
            {
              oprot.writeString(_iter868.getKey());
              {
                oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.DOUBLE, _iter868.getValue().size()));
                for (Map.Entry<Long, Double> _iter869 : _iter868.getValue().entrySet())
                {
                  oprot.writeI64(_iter869.getKey());
                  oprot.writeDouble(_iter869.getValue());
                }
                oprot.writeMapEnd();
              }
            }
  ...
  private static class StormSeriesStatsTupleScheme extends TupleScheme<StormSeriesStats> {
      ...
      if (struct.is_set_times()) {
        {
          ...
          for (long _iter870 : struct.times)
          {
            oprot.writeI64(_iter870);
          }
        }
      }
      if (struct.is_set_values()) {
        {
          ...
          for (Map.Entry<String, Map<Long,Double>> _iter871 : struct.values.entrySet())
          {
            oprot.writeString(_iter871.getKey());
            {
              oprot.writeI32(_iter871.getValue().size());
              for (Map.Entry<Long, Double> _iter872 : _iter871.getValue().entrySet())
              {
                oprot.writeI64(_iter872.getKey());
                oprot.writeDouble(_iter872.getValue());
              }
            }
          }
        }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StormSeriesStats struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.times = new ArrayList<Long>(_list873.size);
          long _elem874;
          for (int _i875 = 0; _i875 < _list873.size; ++_i875)
          {
            _elem874 = iprot.readI64();
            struct.times.add(_elem874);
          }
        }
        struct.set_times_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map876 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.MAP, iprot.readI32());
          struct.values = new HashMap<String,Map<Long,Double>>(2*_map876.size);
          String _key877;
          Map<Long,Double> _val878;
          for (int _i879 = 0; _i879 < _map876.size; ++_i879)
          {
            _key877 = iprot.readString();
            {
              org.apache.thrift.protocol.TMap _map880 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
              _val878 = new HashMap<Long,Double>(2*_map880.size);
              long _key881;
              double _val882;
              for (int _i883 = 0; _i883 < _map880.size; ++_i883)
              {
                _key881 = iprot.readI64();
                _val882 = iprot.readDouble();
                _val878.put(_key881, _val882);
              }
            }
            struct.values.put(_key877, _val878);
          }
        }
        struct.set_values_isSet(true);
      }
