...
public class StatsMetadata implements org.apache.thrift.TBase<StatsMetadata, StatsMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<StatsMetadata> {
        ...
        switch (schemeField.id) {
          case 1: // COMP_IDS
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map980 = iprot.readMapBegin();
                struct.comp_ids = new HashMap<String,Integer>(2*_map980.size);
                String _key981;
                int _val982;
                for (int _i983 = 0; _i983 < _map980.size; ++_i983)
                {
                  _key981 = iprot.readString();
                  _val982 = iprot.readI32();
                  struct.comp_ids.put(_key981, _val982);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.metric_ids = new HashMap<String,Integer>(2*_map984.size);
                String _key985;
                int _val986;
                for (int _i987 = 0; _i987 < _map984.size; ++_i987)
                {
                  _key985 = iprot.readString();
                  _val986 = iprot.readI32();
                  struct.metric_ids.put(_key985, _val986);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_ids = new HashMap<String,Integer>(2*_map988.size);
                String _key989;
                int _val990;
                for (int _i991 = 0; _i991 < _map988.size; ++_i991)
                {
                  _key989 = iprot.readString();
                  _val990 = iprot.readI32();
                  struct.executor_ids.put(_key989, _val990);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.comp_ids != null) {
        if (struct.is_set_comp_ids()) {
          oprot.writeFieldBegin(COMP_IDS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter992 : struct.comp_ids.entrySet())
            {
              oprot.writeString(_iter992.getKey());
              oprot.writeI32(_iter992.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.metric_ids != null) {
        if (struct.is_set_metric_ids()) {
          oprot.writeFieldBegin(METRIC_IDS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter993 : struct.metric_ids.entrySet())
            {
              oprot.writeString(_iter993.getKey());
              oprot.writeI32(_iter993.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.executor_ids != null) {
        if (struct.is_set_executor_ids()) {
          oprot.writeFieldBegin(EXECUTOR_IDS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter994 : struct.executor_ids.entrySet())
            {
              oprot.writeString(_iter994.getKey());
              oprot.writeI32(_iter994.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class StatsMetadataTupleScheme extends TupleScheme<StatsMetadata> {
      ...
      if (struct.is_set_comp_ids()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter995 : struct.comp_ids.entrySet())
          {
            oprot.writeString(_iter995.getKey());
            oprot.writeI32(_iter995.getValue());
          }
        }
      }
      if (struct.is_set_metric_ids()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter996 : struct.metric_ids.entrySet())
          {
            oprot.writeString(_iter996.getKey());
            oprot.writeI32(_iter996.getValue());
          }
        }
      }
      if (struct.is_set_executor_ids()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter997 : struct.executor_ids.entrySet())
          {
            oprot.writeString(_iter997.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StatsMetadata struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map998 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.comp_ids = new HashMap<String,Integer>(2*_map998.size);
          String _key999;
          int _val1000;
          for (int _i1001 = 0; _i1001 < _map998.size; ++_i1001)
          {
            _key999 = iprot.readString();
            _val1000 = iprot.readI32();
            struct.comp_ids.put(_key999, _val1000);
          }
        }
        struct.set_comp_ids_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map1002 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.metric_ids = new HashMap<String,Integer>(2*_map1002.size);
          String _key1003;
          int _val1004;
          for (int _i1005 = 0; _i1005 < _map1002.size; ++_i1005)
          {
            _key1003 = iprot.readString();
            _val1004 = iprot.readI32();
            struct.metric_ids.put(_key1003, _val1004);
          }
        }
        struct.set_metric_ids_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map1006 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.executor_ids = new HashMap<String,Integer>(2*_map1006.size);
          String _key1007;
          int _val1008;
          for (int _i1009 = 0; _i1009 < _map1006.size; ++_i1009)
          {
            _key1007 = iprot.readString();
            _val1008 = iprot.readI32();
            struct.executor_ids.put(_key1007, _val1008);
          }
        }
        struct.set_executor_ids_isSet(true);
      }
