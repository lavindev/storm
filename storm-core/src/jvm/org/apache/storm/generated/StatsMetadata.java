...
public class StatsMetadata implements org.apache.thrift.TBase<StatsMetadata, StatsMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<StatsMetadata> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.comp_ids = new HashMap<String,Integer>(2*_map938.size);
                String _key939;
                int _val940;
                for (int _i941 = 0; _i941 < _map938.size; ++_i941)
                {
                  _key939 = iprot.readString();
                  _val940 = iprot.readI32();
                  struct.comp_ids.put(_key939, _val940);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.metric_ids = new HashMap<String,Integer>(2*_map942.size);
                String _key943;
                int _val944;
                for (int _i945 = 0; _i945 < _map942.size; ++_i945)
                {
                  _key943 = iprot.readString();
                  _val944 = iprot.readI32();
                  struct.metric_ids.put(_key943, _val944);
                }
                iprot.readMapEnd();
              }
          ...
          case 5: // EXECUTOR_IDS
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map946 = iprot.readMapBegin();
                struct.executor_ids = new HashMap<String,Integer>(2*_map946.size);
                String _key947;
                int _val948;
                for (int _i949 = 0; _i949 < _map946.size; ++_i949)
                {
                  _key947 = iprot.readString();
                  _val948 = iprot.readI32();
                  struct.executor_ids.put(_key947, _val948);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.comp_ids != null) {
        if (struct.is_set_comp_ids()) {
          oprot.writeFieldBegin(COMP_IDS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter950 : struct.comp_ids.entrySet())
            {
              oprot.writeString(_iter950.getKey());
              oprot.writeI32(_iter950.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.metric_ids != null) {
        if (struct.is_set_metric_ids()) {
          oprot.writeFieldBegin(METRIC_IDS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter951 : struct.metric_ids.entrySet())
            {
              oprot.writeString(_iter951.getKey());
              oprot.writeI32(_iter951.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.executor_ids != null) {
        if (struct.is_set_executor_ids()) {
          oprot.writeFieldBegin(EXECUTOR_IDS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter952 : struct.executor_ids.entrySet())
            {
              oprot.writeString(_iter952.getKey());
              oprot.writeI32(_iter952.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class StatsMetadataTupleScheme extends TupleScheme<StatsMetadata> {
      ...
      if (struct.is_set_comp_ids()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter953 : struct.comp_ids.entrySet())
          {
      ...
      if (struct.is_set_metric_ids()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter954 : struct.metric_ids.entrySet())
          {
            oprot.writeString(_iter954.getKey());
      ...
      if (struct.is_set_executor_ids()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter955 : struct.executor_ids.entrySet())
          {
            oprot.writeString(_iter955.getKey());
            oprot.writeI32(_iter955.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StatsMetadata struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map956 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.comp_ids = new HashMap<String,Integer>(2*_map956.size);
          String _key957;
          int _val958;
          for (int _i959 = 0; _i959 < _map956.size; ++_i959)
          {
            _key957 = iprot.readString();
            _val958 = iprot.readI32();
            struct.comp_ids.put(_key957, _val958);
          }
        }
        struct.set_comp_ids_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map960 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.metric_ids = new HashMap<String,Integer>(2*_map960.size);
          String _key961;
          int _val962;
          for (int _i963 = 0; _i963 < _map960.size; ++_i963)
          {
            _key961 = iprot.readString();
            _val962 = iprot.readI32();
            struct.metric_ids.put(_key961, _val962);
          }
        }
        struct.set_metric_ids_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map964 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.executor_ids = new HashMap<String,Integer>(2*_map964.size);
          String _key965;
          int _val966;
          for (int _i967 = 0; _i967 < _map964.size; ++_i967)
          {
            _key965 = iprot.readString();
            _val966 = iprot.readI32();
            struct.executor_ids.put(_key965, _val966);
          }
        }
        struct.set_executor_ids_isSet(true);
      }
