...
public class StormWindowedStats implements org.apache.thrift.TBase<StormWindowedStats, StormWindowedStats._Fields>, java.io.Serializable, Cloneable, Comparable<StormWindowedStats> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.values = new HashMap<String,Double>(2*_map870.size);
                String _key871;
                double _val872;
                for (int _i873 = 0; _i873 < _map870.size; ++_i873)
                {
                  _key871 = iprot.readString();
                  _val872 = iprot.readDouble();
                  struct.values.put(_key871, _val872);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.values != null) {
        if (struct.is_set_values()) {
          oprot.writeFieldBegin(VALUES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter874 : struct.values.entrySet())
            {
              oprot.writeString(_iter874.getKey());
              oprot.writeDouble(_iter874.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class StormWindowedStatsTupleScheme extends TupleScheme<StormWindowedStats> {
      ...
      if (struct.is_set_values()) {
        {
          ...
          for (Map.Entry<String, Double> _iter875 : struct.values.entrySet())
          {
            oprot.writeString(_iter875.getKey());
            oprot.writeDouble(_iter875.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StormWindowedStats struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TMap _map876 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.values = new HashMap<String,Double>(2*_map876.size);
          String _key877;
          double _val878;
          for (int _i879 = 0; _i879 < _map876.size; ++_i879)
          {
            _key877 = iprot.readString();
            _val878 = iprot.readDouble();
