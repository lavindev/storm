            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulseIds = new ArrayList<String>(_list942.size);
                String _elem943;
                for (int _i944 = 0; _i944 < _list942.size; ++_i944)
                {
                  _elem943 = iprot.readString();
                  struct.pulseIds.add(_elem943);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBNodes struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulseIds != null) {
        oprot.writeFieldBegin(PULSE_IDS_FIELD_DESC);
        {
          ...
          for (String _iter945 : struct.pulseIds)
          {
      ...
      if (struct.is_set_pulseIds()) {
        {
          ...
          for (String _iter946 : struct.pulseIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulseIds = new ArrayList<String>(_list947.size);
          String _elem948;
          for (int _i949 = 0; _i949 < _list947.size; ++_i949)
          {
            _elem948 = iprot.readString();
            struct.pulseIds.add(_elem948);
          }
        }
        struct.set_pulseIds_isSet(true);
      }
