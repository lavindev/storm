            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulses = new ArrayList<HBPulse>(_list934.size);
                HBPulse _elem935;
                for (int _i936 = 0; _i936 < _list934.size; ++_i936)
                {
                  _elem935 = new HBPulse();
                  _elem935.read(iprot);
                  struct.pulses.add(_elem935);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBRecords struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulses != null) {
        oprot.writeFieldBegin(PULSES_FIELD_DESC);
        {
          ...
          for (HBPulse _iter937 : struct.pulses)
          {
      ...
      if (struct.is_set_pulses()) {
        {
          ...
          for (HBPulse _iter938 : struct.pulses)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulses = new ArrayList<HBPulse>(_list939.size);
          HBPulse _elem940;
          for (int _i941 = 0; _i941 < _list939.size; ++_i941)
          {
            _elem940 = new HBPulse();
            _elem940.read(iprot);
            struct.pulses.add(_elem940);
          }
        }
        struct.set_pulses_isSet(true);
      }
