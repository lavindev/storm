...
public class StatsMetadataTopo implements org.apache.thrift.TBase<StatsMetadataTopo, StatsMetadataTopo._Fields>, java.io.Serializable, Cloneable, Comparable<StatsMetadataTopo> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.topo_ids = new HashMap<String,Integer>(2*_map908.size);
                String _key909;
                int _val910;
                for (int _i911 = 0; _i911 < _map908.size; ++_i911)
                {
                  _key909 = iprot.readString();
                  _val910 = iprot.readI32();
                  struct.topo_ids.put(_key909, _val910);
                }
                iprot.readMapEnd();
              }
          ...
          case 2: // STREAM_IDS
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map912 = iprot.readMapBegin();
                struct.stream_ids = new HashMap<String,Integer>(2*_map912.size);
                String _key913;
                int _val914;
                for (int _i915 = 0; _i915 < _map912.size; ++_i915)
                {
                  _key913 = iprot.readString();
                  _val914 = iprot.readI32();
                  struct.stream_ids.put(_key913, _val914);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.host_ids = new HashMap<String,Integer>(2*_map916.size);
                String _key917;
                int _val918;
                for (int _i919 = 0; _i919 < _map916.size; ++_i919)
                {
                  _key917 = iprot.readString();
                  _val918 = iprot.readI32();
                  struct.host_ids.put(_key917, _val918);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.topo_ids != null) {
        if (struct.is_set_topo_ids()) {
          oprot.writeFieldBegin(TOPO_IDS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter920 : struct.topo_ids.entrySet())
            {
              oprot.writeString(_iter920.getKey());
              oprot.writeI32(_iter920.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.stream_ids != null) {
        if (struct.is_set_stream_ids()) {
          oprot.writeFieldBegin(STREAM_IDS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter921 : struct.stream_ids.entrySet())
            {
              oprot.writeString(_iter921.getKey());
              oprot.writeI32(_iter921.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.host_ids != null) {
        if (struct.is_set_host_ids()) {
          oprot.writeFieldBegin(HOST_IDS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter922 : struct.host_ids.entrySet())
            {
              oprot.writeString(_iter922.getKey());
              oprot.writeI32(_iter922.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class StatsMetadataTopoTupleScheme extends TupleScheme<StatsMetadataTopo> {
      ...
      if (struct.is_set_topo_ids()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter923 : struct.topo_ids.entrySet())
          {
            oprot.writeString(_iter923.getKey());
            oprot.writeI32(_iter923.getValue());
          }
        }
      }
      if (struct.is_set_stream_ids()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter924 : struct.stream_ids.entrySet())
          {
            oprot.writeString(_iter924.getKey());
            oprot.writeI32(_iter924.getValue());
          }
        }
      }
      if (struct.is_set_host_ids()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter925 : struct.host_ids.entrySet())
          {
            oprot.writeString(_iter925.getKey());
            oprot.writeI32(_iter925.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StatsMetadataTopo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map926 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.topo_ids = new HashMap<String,Integer>(2*_map926.size);
          String _key927;
          int _val928;
          for (int _i929 = 0; _i929 < _map926.size; ++_i929)
          {
            _key927 = iprot.readString();
            _val928 = iprot.readI32();
            struct.topo_ids.put(_key927, _val928);
          }
        }
        struct.set_topo_ids_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map930 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.stream_ids = new HashMap<String,Integer>(2*_map930.size);
          String _key931;
          int _val932;
          for (int _i933 = 0; _i933 < _map930.size; ++_i933)
          {
            _key931 = iprot.readString();
            _val932 = iprot.readI32();
            struct.stream_ids.put(_key931, _val932);
          }
        }
        struct.set_stream_ids_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map934 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.host_ids = new HashMap<String,Integer>(2*_map934.size);
          String _key935;
          int _val936;
          for (int _i937 = 0; _i937 < _map934.size; ++_i937)
          {
            _key935 = iprot.readString();
            _val936 = iprot.readI32();
            struct.host_ids.put(_key935, _val936);
          }
        }
        struct.set_host_ids_isSet(true);
      }
